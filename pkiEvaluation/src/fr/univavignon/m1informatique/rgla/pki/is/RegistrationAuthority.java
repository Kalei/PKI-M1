...
public class RegistrationAuthority extends ISComponent implements
	...
	public void revokeCertificate(
			...
			throws PKIException {
		certificationAuthority.revokeCertificate(certificateRevocationRequest);
	...
	/**
	 * @uml.property  name="certificationAuthority1"
	 * @uml.associationEnd  inverse="registrationAuthority:fr.univavignon.m1informatique.rgla.pki.is.CertificationAuthority"
	 */
	private CertificationAuthority certificationAuthority1;

	/**
	 * Getter of the property <tt>certificationAuthority1</tt>
	 * @return  Returns the certificationAuthority1.
	 * @uml.property  name="certificationAuthority1"
	 */
	public CertificationAuthority getCertificationAuthority1() {
		return certificationAuthority1;
	}

	/**
	 * Setter of the property <tt>certificationAuthority1</tt>
	 * @param certificationAuthority1  The certificationAuthority1 to set.
	 * @uml.property  name="certificationAuthority1"
	 */
	public void setCertificationAuthority1(
			CertificationAuthority certificationAuthority1) {
		this.certificationAuthority1 = certificationAuthority1;
	}
