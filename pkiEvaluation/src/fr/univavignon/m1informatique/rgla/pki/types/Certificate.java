 ...
 * <p>
 * Un certificat est une liste chainée d'élémente de certificat. Chaque
 * élément signant l'élément inférieur.
 * 
 * @author mb
 */
public class Certificate implements Serializable {
	...
	/**
	 * @uml.property name="certificateElements"
	 * @uml.associationEnd multiplicity="(0 -1)" inverse=
	 *                     "certificate:fr.univavignon.m1informatique.rgla.pki.types.CertificateElement"
	 */
	 ...
	 * 
	 * @param listOfCertificateElements
	 *            the list of certificate elements
	 */
	public Certificate(List<CertificateElement> listOfCertificateElements) {
		this.certificateElements = listOfCertificateElements != null ? new LinkedList<CertificateElement>(
				listOfCertificateElements) : new LinkedList<CertificateElement>();
	}
	 ...
	 * 
	 * @throws PKIException
	 *             if not valid or not authentic
	 * @throws SecurityException
	 *             if certificate cannot be verified
	 */
	...
	/**
	 * get the certificate of the authority which sign the last certificate
	 * element
	 * 
	 * @return the certificate of the authority which sign the last certificate
	 *         element
	 * @throws PKIException
	 *             if the certificate is empty
	 */
	...
	public boolean equals(Object obj) {
		if (obj != null && obj == Certificate.class) {
			try {
				return this.getLastCertificateElement().getSerialNumber() == ((Certificate) obj)
						.getLastCertificateElement().getSerialNumber();
