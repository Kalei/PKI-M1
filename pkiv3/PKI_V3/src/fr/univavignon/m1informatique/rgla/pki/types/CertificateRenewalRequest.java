...
public class CertificateRenewalRequest extends SignedObjectByCertificate
{
	...
	/**
	 * @uml.property  name="certificateRenewalRequestData"
	 * @uml.associationEnd  inverse="certificateRenewalRequest:fr.univavignon.m1informatique.rgla.pki.types.CertificateRenewalRequestData"
	 */
	private CertificateRenewalRequestData certificateRenewalRequestData;

	/**
	 * Getter of the property <tt>certificateRenewalRequestData</tt>
	 * @return  Returns the certificateRenewalRequestData.
	 * @uml.property  name="certificateRenewalRequestData"
	 */
	public CertificateRenewalRequestData getCertificateRenewalRequestData() {
		return certificateRenewalRequestData;
	}

	/**
	 * Setter of the property <tt>certificateRenewalRequestData</tt>
	 * @param certificateRenewalRequestData  The certificateRenewalRequestData to set.
	 * @uml.property  name="certificateRenewalRequestData"
	 */
	public void setCertificateRenewalRequestData(
			CertificateRenewalRequestData certificateRenewalRequestData) {
		this.certificateRenewalRequestData = certificateRenewalRequestData;
	}
}
